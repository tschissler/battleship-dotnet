...
[![build and test dotnet](https://github.com/tschissler/battleship-dotnet/actions/workflows/buildpipeline.yaml/badge.svg)](https://github.com/tschissler/battleship-dotnet/actions/workflows/buildpipeline.yaml)
